...
//		devCharSexPerks();
	...
	/*
	 * public void devCharSexPerks() { //gives macro sex perks
	 ...
	 * CharCreator.sexPerks.setMacroUdder(true); devCharCombatPerks(); }
	 */
	
	/*
	 * public void devCharCombatPerks() { CharCreator.combatPerks.setMonkLevel(1);
	 * CharCreator.combatPerks.setTankRole(true); devCharName(); }
	 */
...
//		panel.add(GameUtil.createButton("Class Menu", this), GameUtil.setConstraints(0.1, 0, 1, 0, 1, 1));
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("Main Page")) { new MainPage(); } 
		...
		else if (e.getActionCommand().equals("Macro Perk Menu")) { new CharCreator().macroSPerk(); }
